...
> This is a fork of https://github.com/chentau/marks.nvim, removing some features to make it much faster to start.

Example config:
``` lua
vim.opt.runtimepath:append "~/ghq/github.com/cljoly/fast-marks.nvim"
